...
import { walkGet, walkGetObjectSave } from './vuefire/utils'
...
import { VUEXFIRE_INIT_VALUE,
         ...
         VUEXFIRE_SET } from './vuefire/types'
...
if ( String(process.env.VUE_APP_PRODUCTION) === 'false' ) {
  window.gpdev = window.gpdev || {};
  window.gpdev._resultInstanceCache = _resultInstanceCache
  window.gpdev._resultListCache = _resultListCache
}
