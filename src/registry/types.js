// types.js
export const HELIOSRX_INIT_VALUE      = 'heliosrx/INIT_VALUE'
export const HELIOSRX_UNSET_VALUE     = 'heliosrx/UNSET_VALUE'
export const HELIOSRX_ARRAY_SET       = 'heliosrx/ARRAY_SET'
export const HELIOSRX_ARRAY_ADD       = 'heliosrx/ARRAY_ADD'
export const HELIOSRX_ARRAY_REMOVE    = 'heliosrx/ARRAY_REMOVE'
export const HELIOSRX_SET             = 'heliosrx/SET'
